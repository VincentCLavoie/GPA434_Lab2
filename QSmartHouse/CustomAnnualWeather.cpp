...
double CustomAnnualWeather::temperature(size_t secondOfYear) const 
{
	...
	x = 0.5 * (sin((secondOfYear %tannee)/5019110) )+ 0.5; //0.5 * (sin((secondOfYear %tannee * 2 * 3.1416) / (tmois * 12)) )+ 0.5; où tmois = 2628000
	y = 0.5 * (sin((secondOfYear %tannee)/13751) )+ 0.5; //0.5 * (sin((secondOfYear %tanne * 2 * 3.1416) / (theure * 24)) )+ 0.5; où theure = 3600
